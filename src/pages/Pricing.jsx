...
function Pricing() {
    return (
        <div className='bg-gradient-to-b from-primary-100 to-primary-200'>
            <div className='container m-auto px-6 py-20 md:px-12 lg:px-20'>
                <div className='m-auto text-center lg:w-8/12 xl:w-7/12'>
                    <h2 className='text-2xl text-secondary-900 font-bold md:text-4xl'>
                    ...
                    <div className='relative z-10 -mx-4 group md:w-6/12 md:mx-0 lg:w-5/12'>
                        ...
                        <div className='relative p-6 space-y-6 lg:p-8'>
                                ...
                                <div className='relative flex justify-around'>
                                    <div className='flex items-end'>
                                        ...
                                        <div className='pb-2'>
                                            ...
                                            <span className='block text-xl text-primary-500 font-bold'>
                                                Off
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <p className='flex items-center justify-center space-x-4 text-lg text-gray-600 text-center'>
                                ...
                                <a
                                    href='tel:+24300'
                                    className='flex space-x-2 items-center text-primary-600'
                                >
                                    <svg
                            ...
                            <button
                                type='submit'
                                title='Submit'
                                className='block w-full py-3 px-6 text-center rounded-xl transition bg-primary-500 hover:bg-primary-700 active:bg-primary-800 focus:bg-primary-600'
                            >
